...
export const ProductsListScreen = ({navigation, route}) => {

    let productsListId = route.params.item.id

    const loadApi = useCallback(async () => {
        LogBox.ignoreLogs(['VirtualizedLists should never be nested'])
        fetch(`https://pack-trade.com/application/product-category?id=${productsListId}`)
